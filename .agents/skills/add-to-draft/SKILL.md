---
name: add-to-draft
description: SNSの投稿や記事など Codex 関連コンテンツを受け取り、公式ドキュメントで事実確認したうえで、howto_claude/draft.md に新セクションとして追記する。
...
### Step 1: 事実確認
- 主要な主張を公式ドキュメント（code.Codex.com/docs, Codex.com/blog, anthropic.com/engineering）で検証する
